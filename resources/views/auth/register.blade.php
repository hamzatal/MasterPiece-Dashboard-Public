...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input id="phone" class="form-input" type="tel" name="phone" required autocomplete="tel">
                @error('phone')
                <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
    ...
    <script>
        ...
        phoneInput.addEventListener('input', function (e) {
            const phone = e.target.value.replace(/\D/g, ''); // إزالة جميع الأحرف غير الرقمية
            e.target.value = phone; // تحديث القيمة
        });
    </script>
</body>
