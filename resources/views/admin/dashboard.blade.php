    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                'icon' => '
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />',
            ...
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 flex items-center">
                    <div class="flex items-center space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-blue-500" viewBox="0 0 512 512" fill="currentColor">
                        ...
                        <span class="text-gray-800 dark:text-white"> Recent Activities</span>
                    </div>


                </h3>
                @foreach($recentActivities as $activity)
                <div class="border-b border-gray-200 dark:border-gray-700 py-3 flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mt-0.5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h.01M15 12h.01M12 12h.01M6 16h12M6 8h12m-3 4h.01m-6 0h.01" />
                    </svg>
                    <div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b last:border-b-0 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="py-4">
                                        <span class="px-3 py-1 rounded-full text-xs font-medium {{ $statusColors[strtolower($order->status)] ?? 'bg-gray-200 text-gray-800 dark:bg-gray-500 dark:text-white' }}">
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b last:border-b-0 hover:bg-green-50 dark:hover:bg-green-800 transition-colors">
                                ...
                                <td class="py-4 text-gray-800 dark:text-gray-200">{{ $coupon->discount_value }}%</td>
                                <td class="py-4 text-gray-800 dark:text-gray-200">{{ \Carbon\Carbon::parse($coupon->expiry_date)->format('Y-m-d') }}</td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="3" class="py-4 text-center text-gray-500 dark:text-gray-400">No active coupons found.</td>
                            </tr>
                            @endforelse
                        </tbody>
