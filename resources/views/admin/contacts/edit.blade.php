                    ...
                    <form action="{{ route('contacts.update', $contact) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="text" name="subject" id="subject" value="{{ old('subject', $contact->subject) }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                                            @error('subject')
                                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div>
                                            ...
                                            <textarea name="message" id="message" rows="4"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white">{{ old('message', $contact->message) }}</textarea>
                                            @error('message')
                                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                            ...
                            <div class="space-y-6">
                                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            <label for="priority" class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div>
                                            <label for="department" class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <select name="department" id="department"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                                                <option value="general" {{ old('department', $contact->department) == 'general' ? 'selected' : '' }}>General</option>
                                                <option value="sales" {{ old('department', $contact->department) == 'sales' ? 'selected' : '' }}>Sales</option>
                                                <option value="support" {{ old('department', $contact->department) == 'support' ? 'selected' : '' }}>Support</option>
                                                <option value="billing" {{ old('department', $contact->department) == 'billing' ? 'selected' : '' }}>Billing</option>
                                            </select>
                                            @error('department')
                                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                            @enderror
                                ...
                                <!-- Response and Attachment Section -->
                                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4 flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label for="response" class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" />
                                                </svg>
                                                Response
                                            ...
                                            <textarea name="response" id="response" rows="4"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white">{{ old('response', $contact->response) }}</textarea>
                                            @error('response')
                                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div>
                                            <label for="attachment" class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            @if($contact->attachment)
                                                <div class="mb-2 flex items-center text-sm text-gray-600 dark:text-gray-400">
                                                    ...
                                                    Current file: {{ basename($contact->attachment) }}
                                                </div>
                                            @endif
                                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md">
                                                <div class="space-y-1 text-center">
                                                    ...
                                                    <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                                        <label for="attachment" class="relative cursor-pointer rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                        ...
                        <div class="flex items-center justify-end space-x-3 mt-6">
                            <a href="{{ route('contacts.index') }}"
                               class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-md transition-colors duration-150">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
