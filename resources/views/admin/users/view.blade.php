                ...
                <div class="p-8">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center space-x-6">
                            <div class="flex-shrink-0 h-24 w-24 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-2xl flex items-center justify-center text-3xl font-bold shadow-lg">
