                                                ...
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="{{ Storage::url($product->image) }}" alt="product-img">
                                                        </a>
                                ...
                                <nav class="pagination justify-content-center">
                                    ...
                                    <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                        ...
                                        <li class="pagination__list">
                                            <a href="{{ $products->url($products->currentPage()-1) }}" class="pagination__item--arrow  link ">
                                        ...
                                        <li class="pagination__list"><a href="{{ $products->url($i) }}" class="pagination__item   @if ($products->currentPage() == $i) pagination__item--current @endif">{{$i}}</a></li>
                                        @endfor
                                       ...
                                       <li class="pagination__list">
                                        ...
                                        <li class="pagination__list"><a class="pagination__item   pagination__item--current ">1</a></li>
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__categories--menu">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center w-100">
                                            <img class="widget__categories--menu__img" src="{{ Storage::url($category->image) }}" alt="categories-img">
