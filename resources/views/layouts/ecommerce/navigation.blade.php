    ...
    <header class="header__section">
            ...
            <div class="offcanvas__inner">
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="/shop-right-sidebar">Shop</a>
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li">
                                    <a href="#" class="offcanvas__sub_menu_item">Column One</a>
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="/shop-right-sidebar">Shop</a></li>
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    <a href="#" class="offcanvas__sub_menu_item">Column Three</a>
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="/compare">Compare Pages</a></li>
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="/404" class="offcanvas__sub_menu_item">Error Page</a></li>
                            </ul>
                        </li>
        ...
        <div class="offcanvas__stikcy--toolbar">
            <ul class="d-flex justify-content-between">
                ...
                <li class="offcanvas__stikcy--toolbar__list">
                    <a class="offcanvas__stikcy--toolbar__btn" href="/shop-right-sidebar">
                        <span class="offcanvas__stikcy--toolbar__icon">
        ...
        <div class="offCanvas__minicart">
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    ...
                    <div class="minicart__text">
                        <h3 class="minicart__subtitle h4"><a href="/product-details">Oversize Cotton Dress</a></h3>
                ...
                <div class="minicart__product--items d-flex">
                    ...
                    <div class="minicart__text">
                        <h3 class="minicart__subtitle h4"><a href="/product-details">Boxy Denim Jacket</a></h3>
            ...
            <div class="minicart__conditions text-center">
                ...
                <label class="minicart__conditions--label" for="accept">I agree with the <a class="minicart__conditions--link" href="privacy-policy">Privacy and Policy</a></label>
            </div>
